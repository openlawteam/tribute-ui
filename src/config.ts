...
export const DAO_FACTORY_CONTRACT_ADDRESS = {
  [CHAINS.MAINNET]: '',
  [CHAINS.ROPSTEN]: '',
  [CHAINS.RINKEBY]: '0x2eA5a3dB273afD5017cb2CDD48e180811e370803',
  [CHAINS.GOERLI]: '',
  [CHAINS.KOVAN]: '',
...
export const BANK_FACTORY_CONTRACT_ADDRESS = {
  [CHAINS.MAINNET]: '',
  [CHAINS.ROPSTEN]: '',
  [CHAINS.RINKEBY]: '0x74941BBA05b9712e69Effe8f0F6c152014F8C64B',
  [CHAINS.GOERLI]: '',
  [CHAINS.KOVAN]: '',
...
export const NFT_COLLECTION_FACTORY_CONTRACT_ADDRESS = {
  [CHAINS.MAINNET]: '',
  [CHAINS.ROPSTEN]: '',
  [CHAINS.RINKEBY]: '0xe6c6f088be4f7EA4c2a78dbE7724B2dAdd3FD9c3',
  [CHAINS.GOERLI]: '',
  [CHAINS.KOVAN]: '',
...
export const VOTING_CONTRACT_ADDRESS = {
  [CHAINS.MAINNET]: '',
  [CHAINS.ROPSTEN]: '',
  [CHAINS.RINKEBY]: '0x256234EA8e039F86Bf31EB4c3aEA01e69210D118',
  [CHAINS.GOERLI]: '',
  [CHAINS.KOVAN]: '',
...
export const CONFIGURATION_CONTRACT_ADDRESS = {
  [CHAINS.MAINNET]: '',
  [CHAINS.ROPSTEN]: '',
  [CHAINS.RINKEBY]: '0x05F2b208E516854cA593D8cdf63659C21BA0183F',
  [CHAINS.GOERLI]: '',
  [CHAINS.KOVAN]: '',
...
export const RAGEQUIT_CONTRACT_ADDRESS = {
  [CHAINS.MAINNET]: '',
  [CHAINS.ROPSTEN]: '',
  [CHAINS.RINKEBY]: '0x89F64c1836B990A8d8AB38F7A679C2439b775a48',
  [CHAINS.GOERLI]: '',
  [CHAINS.KOVAN]: '',
...
export const MANAGING_CONTRACT_ADDRESS = {
  [CHAINS.MAINNET]: '',
  [CHAINS.ROPSTEN]: '',
  [CHAINS.RINKEBY]: '0xE485a9b0D1B0CC8f9ba42c3245C30dce02c98Aa4',
  [CHAINS.GOERLI]: '',
  [CHAINS.KOVAN]: '',
...
export const FINANCING_CONTRACT_ADDRESS = {
  [CHAINS.MAINNET]: '',
  [CHAINS.ROPSTEN]: '',
  [CHAINS.RINKEBY]: '0xd15C1F5F2E9f385ba60E5bBF790B5F3275c67972',
  [CHAINS.GOERLI]: '',
  [CHAINS.KOVAN]: '',
...
export const ONBOARDING_CONTRACT_ADDRESS = {
  [CHAINS.MAINNET]: '',
  [CHAINS.ROPSTEN]: '',
  [CHAINS.RINKEBY]: '0xf61105f93772976902A6b66EED93BE7dB42aCE01',
  [CHAINS.GOERLI]: '',
  [CHAINS.KOVAN]: '',
...
export const GUILDKICK_CONTRACT_ADDRESS = {
  [CHAINS.MAINNET]: '',
  [CHAINS.ROPSTEN]: '',
  [CHAINS.RINKEBY]: '0x480070BA436dEA59509AD9C507d726b25a702607',
  [CHAINS.GOERLI]: '',
  [CHAINS.KOVAN]: '',
...
export const BANK_ADAPTER_CONTRACT_ADDRESS = {
  [CHAINS.MAINNET]: '',
  [CHAINS.ROPSTEN]: '',
  [CHAINS.RINKEBY]: '0x63fF986cA13B29a15957816A99E0f1DDfdf7BA44',
  [CHAINS.GOERLI]: '',
  [CHAINS.KOVAN]: '',
...
export const COUPONONBOARDING_CONTRACT_ADDRESS = {
  [CHAINS.MAINNET]: '',
  [CHAINS.ROPSTEN]: '',
  [CHAINS.RINKEBY]: '0x4eC2Aa9A71c29367d61e3Df2aE7CA5501eC9496C',
  [CHAINS.GOERLI]: '',
  [CHAINS.KOVAN]: '',
...
export const TRIBUTE_CONTRACT_ADDRESS = {
  [CHAINS.MAINNET]: '',
  [CHAINS.ROPSTEN]: '',
  [CHAINS.RINKEBY]: '0x060FEFB4b596d5f9276E2108ddCE3C2360c4C433',
  [CHAINS.GOERLI]: '',
  [CHAINS.KOVAN]: '',
...
export const DISTRIBUTE_CONTRACT_ADDRESS = {
  [CHAINS.MAINNET]: '',
  [CHAINS.ROPSTEN]: '',
  [CHAINS.RINKEBY]: '0xAF2c880fBAaA556BD613B080cE841Bdb12CBA5E1',
  [CHAINS.GOERLI]: '',
  [CHAINS.KOVAN]: '',
...
export const TRIBUTE_NFT_CONTRACT_ADDRESS = {
  [CHAINS.MAINNET]: '',
  [CHAINS.ROPSTEN]: '',
  [CHAINS.RINKEBY]: '0xe3611DC953187648ECb73A280CC02146F9243c1d',
  [CHAINS.GOERLI]: '',
  [CHAINS.KOVAN]: '',
...
export const OFFCHAINVOTING_CONTRACT_ADDRESS = {
  [CHAINS.MAINNET]: '',
  [CHAINS.ROPSTEN]: '',
  [CHAINS.RINKEBY]: '0x2347dc24d594eedEA355dEA1aBCbC3De4Ae779c3',
  [CHAINS.GOERLI]: '',
  [CHAINS.KOVAN]: '',
