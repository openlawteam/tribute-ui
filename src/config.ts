...
export const DAO_FACTORY_CONTRACT_ADDRESS = {
  ...
  [CHAINS.GOERLI]: '',
  [CHAINS.KOVAN]: '',
  [CHAINS.GANACHE]: '0xe38e1Ea1cbE7a306A96b4b89fbC48f033F4D2870',
};
...
export const BANK_EXTENSION_CONTRACT_ADDRESS = {
  ...
  [CHAINS.GOERLI]: '',
  [CHAINS.KOVAN]: '',
  [CHAINS.GANACHE]: '0x088E6FECd702f58a271eFd069e532e9863342bF1',
};
...
export const VOTING_CONTRACT_ADDRESS = {
  ...
  [CHAINS.GOERLI]: '',
  [CHAINS.KOVAN]: '',
  [CHAINS.GANACHE]: '0xcdCa2059D0d295aFE0AdB3556814738E66Ba6E8A',
};
...
export const CONFIGURATION_CONTRACT_ADDRESS = {
  ...
  [CHAINS.GOERLI]: '',
  [CHAINS.KOVAN]: '',
  [CHAINS.GANACHE]: '0xd0D0Cf90296083969B6827796EE26849d1A27Bc1',
};
...
export const RAGEQUIT_CONTRACT_ADDRESS = {
  ...
  [CHAINS.GOERLI]: '',
  [CHAINS.KOVAN]: '',
  [CHAINS.GANACHE]: '0x12a32Dd21Ed7d7E08EFd2554a3Ec9B9DfdA3a56e',
};
...
export const MANAGING_CONTRACT_ADDRESS = {
  ...
  [CHAINS.GOERLI]: '',
  [CHAINS.KOVAN]: '',
  [CHAINS.GANACHE]: '0xf882F2454C29854C1854c0Cd077f87e81C3ABeA3',
};
...
export const FINANCING_CONTRACT_ADDRESS = {
  ...
  [CHAINS.GOERLI]: '',
  [CHAINS.KOVAN]: '',
  [CHAINS.GANACHE]: '0xfF53890f1424fC3a342F1EfB188e99B0c8574950',
};
...
export const ONBOARDING_CONTRACT_ADDRESS = {
  ...
  [CHAINS.GOERLI]: '',
  [CHAINS.KOVAN]: '',
  [CHAINS.GANACHE]: '0x896292Cb6057BF87d7E2719F1F3b813662a0d9d7',
};
...
export const GUILDKICK_CONTRACT_ADDRESS = {
  ...
  [CHAINS.GOERLI]: '',
  [CHAINS.KOVAN]: '',
  [CHAINS.GANACHE]: '0x8AbE25f48224B7d56692729e9112E757475aAB15',
};
...
export const WITHDRAW_CONTRACT_ADDRESS = {
  ...
  [CHAINS.GOERLI]: '',
  [CHAINS.KOVAN]: '',
  [CHAINS.GANACHE]: '0x78Ff747b7E2Fa9D04dc7682B31e76a237C18c036',
};
...
export const COUPONONBOARDING_CONTRACT_ADDRESS = {
  ...
  [CHAINS.GOERLI]: '',
  [CHAINS.KOVAN]: '',
  [CHAINS.GANACHE]: '0x3d800240E2AbEf32f485509EcfB60c60c7Fe06A8',
};
...
export const TRIBUTE_CONTRACT_ADDRESS = {
  ...
  [CHAINS.GOERLI]: '',
  [CHAINS.KOVAN]: '',
  [CHAINS.GANACHE]: '0xF6E3B9Af793D479F37defB7F14EBDD97422BDdf9',
};
...
export const DISTRIBUTE_CONTRACT_ADDRESS = {
  ...
  [CHAINS.GOERLI]: '',
  [CHAINS.KOVAN]: '',
  [CHAINS.GANACHE]: '0xe6EaFD75028F011De8E951dc29dffCCe97478AA1',
};
...
export const SNAPSHOTPROPSAL_CONTRACT_ADDRESS = {
  ...
  [CHAINS.GOERLI]: '',
  [CHAINS.KOVAN]: '',
  [CHAINS.GANACHE]: '0x2fC12DEa0767AfEC59AB3f4428761544e78e505f',
};
...
export const OFFCHAINVOTING_CONTRACT_ADDRESS = {
  ...
  [CHAINS.GOERLI]: '',
  [CHAINS.KOVAN]: '',
  [CHAINS.GANACHE]: '0xfEc0505F5e30F3219bEbEc93d7d12687F9f878D4',
};
