...
export const SNAPSHOTPROPSAL_CONTRACT_ADDRESS = {
  [CHAINS.MAINNET]: '',
  [CHAINS.ROPSTEN]: '',
  [CHAINS.RINKEBY]: '0x9EFC40404e260a10322471E931E12Dc5592B94e7',
  [CHAINS.GOERLI]: '',
  [CHAINS.KOVAN]: '',
  [CHAINS.GANACHE]: '0x9EFC40404e260a10322471E931E12Dc5592B94e7',
};

// @todo
export const KICK_BAD_REPORTER_CONTRACT_ADDRESS = {
  [CHAINS.MAINNET]: '',
  [CHAINS.ROPSTEN]: '',
  [CHAINS.RINKEBY]: '0x07C56492D30bEB37B335078f29F1b03DE46aBba1',
  [CHAINS.GOERLI]: '',
  [CHAINS.KOVAN]: '',
  [CHAINS.GANACHE]: '0x6679E7AB315A6DD68Ea624675807555700Cf9EC9',
};
