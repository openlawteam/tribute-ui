...
export const CHAIN_NAME_FULL = {
  ...
  [CHAINS.HARMONY]: 'Harmony Network',
  [CHAINS.HARMONYTEST]: 'Harmony Test Network'
};
...
export const ETHERSCAN_URLS: {[chainId: number]: string} = {
  ...
  [CHAINS.HARMONY]: `https://explorer.harmony.one`,
  [CHAINS.HARMONYTEST]: `https://explorer.pops.one`,
};
...
export const INFURA_WS_URLS: {[chainId: number]: string} = {
  ...
  [CHAINS.HARMONY]: `wss://ws.s0.t.hmny.io`,
  [CHAINS.HARMONYTEST]: `wss://ws.s0.b.hmny.io`,
};
